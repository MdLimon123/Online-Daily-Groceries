...
import com.example.onlinedailygroceries.ProductDelails;
...
public class RecentlyViewedAdapter extends RecyclerView.Adapter<RecentlyViewedAdapter.RecentlyViewedViewHolder> {
    ...
    public RecentlyViewedViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.recently_viewed_itemst,parent,false);
    ...
    public void onBindViewHolder(@NonNull RecentlyViewedViewHolder holder,final int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(context, ProductDelails.class);
                ...
                i.putExtra("dese",recentlyViewedList.get(position).getDescription());
    ...
    public  static  class RecentlyViewedViewHolder extends RecyclerView.ViewHolder{
        ...
        public RecentlyViewedViewHolder(@NonNull View itemView) {
            ...
            qty = itemView.findViewById(R.id.qrt);
